...
public class JokerappTestContainer extends TestContainer {

    public JokerappTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/joker/jokerapp/app.properties",
    ...
    public static class Common extends JokerappTestContainer {

        public static final JokerappTestContainer.Common INSTANCE = new JokerappTestContainer.Common();
